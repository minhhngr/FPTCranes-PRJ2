...
from pages import (
    page01_data_basic_clean,page02_data_ready,page03_segmentation,
    page04_model_comparison,page05_best_model,page06_prediction,
    page07_integrated,page08_full_pipeline,
)
...
with st.sidebar:
    ...
    st.caption("Outputs-first dashboard. New-data processing calls the same isolated offline orchestrator used by the release pipeline.")
